...
Thank you for using **Deskmark**! We highly value your privacy. This document explains how we handle your data when you use this app.
...
**Important Note:** Deskmark operates completely offline. It does not collect, store, or transmit any personal information. The app does not connect to remote servers or integrate any third-party services.
...
Deskmark does not generate or send any logs. All operations and configurations are performed locally, with no remote communication involved.

## Use of Data

Since Deskmark does not collect or store any user data, there is no use or sharing of data. All of your usage remains private and offline.

## Third-Party Services

Deskmark does not use any third-party analytics tools, advertising platforms, or cloud services, nor does it share or sell user information to any third party.
...
* You may delete all Deskmark data and settings at any time.
...
This policy is effective as of **December 2, 2025**.
